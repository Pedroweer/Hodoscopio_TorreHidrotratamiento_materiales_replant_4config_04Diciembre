...
G4TowEventAction::G4TowEventAction(Event& theEvent) : 
	fEvent(theEvent),
	G4UserEventAction()
{
...
G4TowEventAction::~G4TowEventAction()
{
		
}

void
G4TowEventAction::BeginOfEventAction(const G4Event*)
{

}

void 
G4TowEventAction::EndOfEventAction(const G4Event*)
{
