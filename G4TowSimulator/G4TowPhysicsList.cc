// implementation of the G4TowPhysicsList class
...
G4TowPhysicsList::G4TowPhysicsList(G4String physName) : G4VModularPhysicsList()
{
...
G4TowPhysicsList::~G4TowPhysicsList()
{
		//delete fMessenger;
...
void 
G4TowPhysicsList::ConstructParticle()
{
...
void 
G4TowPhysicsList::ConstructProcess()
{
...
void 
G4TowPhysicsList::RemoveFromPhysicsList(const G4String& name)
{
...
void 
G4TowPhysicsList::SetAbsorption(G4bool toggle)
{
...
void 
G4TowPhysicsList::SetCutForGamma(G4double cut)
{
	fCutForGamma = cut;
...
void 
G4TowPhysicsList::SetCutForElectron(G4double cut)
{
	fCutForElectron = cut;
...
void 
G4TowPhysicsList::SetCutForPositron(G4double cut)
{
	fCutForPositron = cut;
...
void 
G4TowPhysicsList::SetStepMax(G4double step)
{
	fStepMaxProcess->SetStepMax(step);
}

StepMax* 
G4TowPhysicsList::GetStepMaxProcess()
{
	return fStepMaxProcess;
}

void 
G4TowPhysicsList::AddStepMax()
{
...
void 
G4TowPhysicsList::SetNbOfPhotonsCerenkov(G4int maxNumber)
{
...
void 
G4TowPhysicsList::SetVerbose(G4int verbose)
{
