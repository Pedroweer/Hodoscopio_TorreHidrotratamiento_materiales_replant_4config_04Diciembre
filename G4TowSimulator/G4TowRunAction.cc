// implementation of the G4TowRunAction class
#include "G4Timer.hh"
#include "G4Run.hh"
#include "g4root.hh"
...
G4TowRunAction::G4TowRunAction(Event& theEvent)
 : G4UserRunAction(),
 fEvent(theEvent)
{
	G4cout << "...G4TowRunAction..." << G4endl;
	
}


G4TowRunAction::~G4TowRunAction()
{	
...
void 
G4TowRunAction::BeginOfRunAction(const G4Run* aRun)
{
...
void 
G4TowRunAction::EndOfRunAction(const G4Run* aRun)
{ 
