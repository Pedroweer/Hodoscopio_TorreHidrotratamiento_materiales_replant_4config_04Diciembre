...
namespace 
{
	void ProgramUsage() 
	{
		...
		cerr << " ./G4TowSimulator [ -c ConfigFile.json ] " << endl;
	}
...
int main(int argc, char** argv) 
{
	...
	if (argc < 3) {
		ProgramUsage();
		throw invalid_argument("[ERROR] G4TowSimulator::main: A configuration file is needed!");
	}
